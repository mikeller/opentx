...
#endif
#define PORT_INTERVAL_ROWS(x)             (x==INTERNAL_MODULE ? INTERNAL_MODULE_INTERVAL_ROWS : (x==EXTERNAL_MODULE ? EXTERNAL_MODULE_INTERVAL_ROWS : 1))
    ...
    case ITEM_MODEL_TRAINER_LINE1:
      ...
      case ITEM_MODEL_EXTERNAL_MODULE_INTERVAL:
      {
        ...
        if ((int8_t)PORT_INTERVAL_ROWS(moduleIdx) >= 0) {
          uint8_t sendAllChannelsInterval = moduleData.pxx.sendAllChannelsInterval;
          moduleData.pxx.sendAllChannelsInterval = min(max(sendAllChannelsInterval, MIN_MAX_SEND_ALL_CHANNELS_INTERVAL), MAX_MAX_SEND_ALL_CHANNELS_INTERVAL);
